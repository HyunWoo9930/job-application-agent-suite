...
AGENT_FILES = {
    ...
    "agent-06b": "agent-06b-human-voice-enhancer.md",
    "06": "agent-06-ai-style-and-qa-reviewer.md",
    "06b": "agent-06b-human-voice-enhancer.md",
    ...
    "human-voice": "agent-06b-human-voice-enhancer.md",
    "humanize": "agent-06b-human-voice-enhancer.md",
    "voice": "agent-06b-human-voice-enhancer.md",
